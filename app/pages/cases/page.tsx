        ...
        <section id='casesp-sec'>
            ...
            <div id='casesp-container1'>
                ...
                <p id='casesp-container1-text'
                   className='fs5 mfs6 i-m'>{`Мы предоставляем комплексные решения по проектированию, монтажу и обслуживанию систем безопасности для ведущих предприятий и организаций. Наша команда обеспечивает надежную защиту объектов различных отраслей — от энергетики и промышленности до банков и торгово-развлекательных комплексов.`}</p>
            </div>
